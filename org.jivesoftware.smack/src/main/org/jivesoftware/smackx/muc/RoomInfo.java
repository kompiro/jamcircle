...
public class RoomInfo {
    ...
    RoomInfo(DiscoverInfo info) {
        ...
        if (form != null) {
            FormField descriptionField = form.getField("muc#roominfo_description");
            if(descriptionField != null){
            	this.description = descriptionField.getValues().next();
            }
            FormField subjectField = form.getField("muc#roominfo_subject");
            if (subjectField != null){
            	Iterator<String> values = subjectField.getValues();
            	if(values.hasNext()) {
