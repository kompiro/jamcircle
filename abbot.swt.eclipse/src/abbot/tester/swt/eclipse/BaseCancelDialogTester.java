...
/**
 * abstract base class for testing wizard dialogs in order to close the dialog, this class clicks
 * Cancel
 */
public abstract class BaseCancelDialogTester extends BaseJFaceDialogTester {
	...
	protected static final ResourceBundle _bundleForJFace = ResourceBundle
			.getBundle(JFACE_BUNDLE_NAME);
