 ...
 * 
 * @author tlroche
 * @version $Id: Utils.java 2376 2007-05-18 12:54:45Z gjohnsto $
 */
public class Utils {
	 ...
	 * @param selection
	 *            an {@link ISelection}
	 * @return <code>true</code> if selection is null or empty, <code>false</code> otherwise
	 */
	 ...
	 * 
	 * @param s
	 *            <code>String</code> is empty or <code>null</code>
	 * @return boolean
	 */
	...
	/**
	 * @param buffer
	 * @return <code>true</code> if the buffer is null or empty, <code>false</code> otherwise
	 */
	...
	/**
	 * Tests if the <code>Map</code> (which is not a <code>Collection</code>) is empty or
	 * <code>null</code>
	 * 
	 * @return boolean
	 */
	 ...
	 * 
	 * @param l
	 *            <code>Collection</code> is empty or <code>null</code>
	 * @return boolean
	 */
	...
	/**
	 * Just sticks all the strings together with '/' CONTRACT: user must ensure that param is not
	 * empty, and each member of param is not empty.
	 */
	...
	/**
	 * Just sticks all the strings together with '/' CONTRACT: user must ensure that each param is
	 * not empty.
	 */
	...
	public static void safeJoin(Thread t) {
		/*
		 * You can't wait for UI threads to finish using join because this keeps the display loop
		 * from running. Instead we use actionDelay and poll the status of the running thread,
		 * returning when it has exited.
		 */
