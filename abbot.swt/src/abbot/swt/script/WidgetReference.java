...
import abbot.swt.finder.matchers.CompositeMatcher;
...
/**
 * This class contains a subset of the functionality of <code>abbot.script.ComponentReference</code>,
 * omitting code that is related to scripting/XML.
 */
...
//	private WidgetFinder finder;
	 ...
	 *            Name of the widget, or null
	 * @param tag
	 *            Tag as returned by WidgetTester.getTag(Widget)
	 */
...
//		this.finder = WidgetFinderImpl.getDefault();
	...
	public Point getInvocationLocation() {
		return point;
	}
	...
	public Widget getWidget() throws NotFoundException, MultipleFoundException {
		if (resolver == null)
			throw new NotFoundException("No default hierarchy has been provided");
		return getWidget(resolver.getHierarchy());
	}

	public Widget getWidget(WidgetHierarchy hierarchy) throws NotFoundException,
		...
		return finder.find(new CompositeMatcher<Widget>(matcher));
