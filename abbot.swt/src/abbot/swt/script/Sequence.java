...
public class Sequence extends Step {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3923567008450348140L;
        ...
        synchronized(sequence) {
            ...
            while (iter.hasNext()) {
                ...
                if (obj instanceof Element)
                    ...
                    addStep(new abbot.swt.script.Comment(getResolver(), text));
                }
            }
        }
    }
    ...
    protected Element addContent(Element el) {
        ...
        while (iter.hasNext()) {
            ...
            if (step instanceof abbot.swt.script.Comment)
