 ...
 */
public class ScriptingConsoleInputStream extends InputStream {
	/**
	 ...
	 *            I/O console
	 */
	public ScriptingConsoleInputStream(IScriptingConsole console) {
	 ...
	 * 
	 * @param newFontStyle
	 *            the font style to be used to decorate input in the associated
	 *            console
	 */
