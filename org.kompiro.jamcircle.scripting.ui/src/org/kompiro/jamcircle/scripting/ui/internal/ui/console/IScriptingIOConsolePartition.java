 ...
 * @since 3.1
 */
public class IScriptingIOConsolePartition implements ITypedRegion {
     ...
     */
    private ScriptingConsoleOutputStream outputStream;
     ...
     */
    public IScriptingIOConsolePartition(ScriptingConsoleOutputStream outputStream, int length) {
     ...
     */
    public IScriptingIOConsolePartition(ScriptingConsoleInputStream inputStream, String text) {
     ...
     */
    ScriptingConsoleOutputStream getStream() {
        return outputStream;
    }
}
